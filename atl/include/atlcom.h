/*
 * Combined ATL COM header for standalone (non-Windows) builds.
 *
 * C++ class stubs derived from ReactOS ATL:
 *   https://github.com/reactos/reactos/blob/master/sdk/lib/atl/atlcom.h
 *
 * Requires Wine ocidl.h for IConnectionPointContainer, IProvideClassInfo2, etc.
 */
...
class CComCoClass {
  template <class Q>
    static HRESULT CreateInstance(IUnknown* punkOuter, Q** pp)
    {
      ...
      return T::_CreatorClass::CreateInstance(punkOuter, __wine_uuidof_type<Q>::inst::uuid, (void**) pp);
#else
    ...
    {
#ifdef __LIBWINEVBS__
      return T::_CreatorClass::CreateInstance(NULL, __wine_uuidof_type<Q>::inst::uuid, (void**) pp);
#else
