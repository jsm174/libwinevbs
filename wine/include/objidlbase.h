/*** Autogenerated by WIDL 11.13 from include/objidlbase.idl - Do not edit ***/
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IActivationFilter, 0x00000017, 0x0000, 0x0000, 0xc0,0x00, 0x00,0x00,0x00,0x00,0x00,0x46)
#endif
#else
...
#else
/*** IUnknown methods ***/
static inline HRESULT IActivationFilter_QueryInterface(IActivationFilter* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IActivationFilter_AddRef(IActivationFilter* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IActivationFilter_Release(IActivationFilter* This) {
    return This->lpVtbl->Release(This);
}
/*** IActivationFilter methods ***/
static inline HRESULT IActivationFilter_HandleActivation(IActivationFilter* This,DWORD dwActivationType,REFCLSID rclsid,CLSID *pReplacementClsId) {
    return This->lpVtbl->HandleActivation(This,dwActivationType,rclsid,pReplacementClsId);
}
#endif
#endif
